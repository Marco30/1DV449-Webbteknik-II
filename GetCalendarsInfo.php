...
class GetCalendarsInfo
{
    ...
    public function __construct($iURL, CURL $iCURL)
    {
        ...
        $links = $this->GetAllCalendarLinks($this->HTMLdata);// hittar och hämtar all länkar som finn i datan som hämtatas från kalender sidan

        foreach ($links as $link)// loppar igenom links arrayen som har alla länkar
        {
